      ...
      <header>
        ...
        <div className={`rightNav ${sidetoggle ? "active" : "" } `  }>
          <ul>
            ...
            <li><Link to="/all-color" onClick={handletoggleBtn}> <i class="fa-solid fa-tag"></i> Manage Color</Link></li>
            <li><Link to="/all-size" onClick={handletoggleBtn}> <i class="fa-solid fa-tag"></i> Manage Size</Link></li>
            <li><Link to="/all-flover" onClick={handletoggleBtn}> <i class="fa-solid fa-tag"></i> Manage Flover</Link></li>
